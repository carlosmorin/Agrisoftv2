...
ActiveRecord::Schema.define(version: 20_201_109_004_328) do
  ...
  create_table 'bank_accounts', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[accountable_type accountable_id], name: 'index_bank_accounts_on_accountable_type_and_accountable_id'
  ...
  create_table 'contacts', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[contactable_type contactable_id], name: 'index_contacts_on_contactable_type_and_contactable_id'
  end
  ...
  create_table 'fiscals', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[fiscalable_type fiscalable_id], name: 'index_fiscals_on_fiscalable_type_and_fiscalable_id'
  end
  ...
  create_table 'freights', force: :cascade do |t|
    ...
    t.index %w[debtable_type debtable_id], name: 'index_freights_on_debtable_type_and_debtable_id'
  ...
  create_table 'shipments_products', force: :cascade do |t|
    ...
    t.index %w[productable_type productable_id], name: 'index_shipments_products_on_productable_type_and_productable_id'
  ...
  create_table 'subcategories', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[categorytable_type categorytable_id], name: 'index_subcategories_on_categorytable_type_and_categorytable_id'
  end
