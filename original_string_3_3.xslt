...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:pago10="http://www.sat.gob.mx/Pagos" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecc12="http://www.sat.gob.mx/EstadoDeCuentaCombustible12" xmlns:consumodecombustibles11="http://www.sat.gob.mx/ConsumoDeCombustibles11" xmlns:gceh="http://www.sat.gob.mx/GastosHidrocarburos10" xmlns:ieeh="http://www.sat.gob.mx/IngresosHidrocarburos10">
  ...
  <!--
	...
	-->
  <xsl:include href="http://sat.ukko.mx/cadenaoriginal_2_0_utilerias.xslt"/>
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
  <xsl:include href="http://sat.ukko.mx/ecc11.xslt"/> 
  <xsl:include href="http://sat.ukko.mx/donat11.xslt"/>
  <xsl:include href="http://sat.ukko.mx/divisas.xslt"/>
  <xsl:include href="http://sat.ukko.mx/implocal.xslt"/>
  <xsl:include href="http://sat.ukko.mx/leyendasFisc.xslt"/>
  <xsl:include href="http://sat.ukko.mx/pfic.xslt"/>
  <xsl:include href="http://sat.ukko.mx/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="http://sat.ukko.mx/nomina12.xslt"/>
  <xsl:include href="http://sat.ukko.mx/cfdiregistrofiscal.xslt"/>
  <xsl:include href="http://sat.ukko.mx/pagoenespecie.xslt"/>
  <xsl:include href="http://sat.ukko.mx/aerolineas.xslt"/>
  <xsl:include href="http://sat.ukko.mx/valesdedespensa.xslt"/>
  <xsl:include href="http://sat.ukko.mx/consumodecombustibles.xslt"/>
  <xsl:include href="http://sat.ukko.mx/notariospublicos.xslt"/>
  <xsl:include href="http://sat.ukko.mx/vehiculousado.xslt"/>
  <xsl:include href="http://sat.ukko.mx/servicioparcialconstruccion.xslt"/>
  <xsl:include href="http://sat.ukko.mx/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="http://sat.ukko.mx/certificadodedestruccion.xslt"/>
  <xsl:include href="http://sat.ukko.mx/obrasarteantiguedades.xslt"/>
  <xsl:include href="http://sat.ukko.mx/ComercioExterior11.xslt"/>
  <xsl:include href="http://sat.ukko.mx/ine11.xslt"/>
  <xsl:include href="http://sat.ukko.mx/iedu.xslt"/>
  <xsl:include href="http://sat.ukko.mx/ventavehiculos11.xslt"/>
  <xsl:include href="http://sat.ukko.mx/terceros11.xslt"/>
  <xsl:include href="http://sat.ukko.mx/Pagos10.xslt"/>
  <xsl:include href="http://sat.ukko.mx/detallista.xslt"/>
  <xsl:include href="http://sat.ukko.mx/ecc12.xslt"/>
  <xsl:include href="http://sat.ukko.mx/consumodeCombustibles11.xslt"/>
  <xsl:include href="http://sat.ukko.mx/GastosHidrocarburos10.xslt"/>
  <xsl:include href="http://sat.ukko.mx/IngresosHidrocarburos.xslt"/>
