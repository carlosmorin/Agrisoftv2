  ...
  class ContractsController < ApplicationController
    ...
    def contract_params
      params.require(:contract).permit(:name, :client_id, :started_at,
                                       ...
                                       contracts_products_attributes: %i[id contract_id product_id currency_id quantity price _destroy],
                                       contracts_expenses_attributes: %i[id contract_id expense_id unit_sale currency_id price percentage _destroy])
    end
